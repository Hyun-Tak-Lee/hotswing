...
class CourtViewSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final assigned = _CourtSegmentOption(
      label: '경기 코트',
    ...
    final standby = _CourtSegmentOption(
      label: '대기 코트',
...
class _CourtSegmentOption extends StatelessWidget {
  const _CourtSegmentOption({
    required this.label,
    required this.value,
    required this.selectedView,
    required this.onSelectionChanged,
    ...
    required this.courtColors,
  });

  final String label;
  final CourtViewSection value;
  final CourtViewSection selectedView;
  final ValueChanged<CourtViewSection> onSelectionChanged;
  final bool isLandscape;
  final bool isTablet;
      ...
      child: AnimatedContainer(
        ...
        child: Text(
          ...
          style: TextStyle(
            ...
            color: isSelected
                ? courtColors.courtSelectActiveText
                : courtColors.courtSelectInactiveText,
          ),
        ),
      ),
    );
