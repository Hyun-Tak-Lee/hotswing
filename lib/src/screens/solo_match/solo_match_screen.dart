...
/// 개인전 매칭 및 코트 배정, 대기열 패널을 표시하는 메인 화면 위젯.
class SoloMatchScreen extends StatefulWidget {
  /// [SoloMatchScreen] 생성자.
  const SoloMatchScreen({super.key});

  @override
  State<SoloMatchScreen> createState() => _SoloMatchScreenState();
}
